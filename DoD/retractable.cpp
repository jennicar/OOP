...
Retractable::Retractable() : retracted(false), earphoneLength(50), totalEarphoneLength(100) {}

void Retractable::setEarphoneLength(int _earphoneLength) { this->earphoneLength = _earphoneLength; }
int Retractable::getEarphoneLenth() { return this->earphoneLength; }
